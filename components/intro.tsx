...
import PortfolioPic from "../public/portfolioPic.jpeg";
...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className=" w-24 rounded border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
        </div>
      </div>
      ...
      >
        <span className="font-bold">Hello, I'm Jared.</span> I'm a{" "}
